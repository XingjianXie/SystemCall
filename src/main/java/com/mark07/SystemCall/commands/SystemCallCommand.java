...
public class SystemCallCommand {
     ...
     */
    public static int generateItemElement(CommandSourceStack commandSourceStack, ItemInput itemInput)
            throws CommandSyntaxException {
        ServerPlayer player = commandSourceStack.getPlayerOrException();
        ...
        if (!cost(commandSourceStack, cost)) return 0;
         */
     ...
     */
    public static int transferHumanUnitDurability(CommandSourceStack commandSourceStack, String origin, String target)
            throws CommandSyntaxException {
        ServerPlayer player = commandSourceStack.getPlayerOrException();
    ...
    public static void register(CommandDispatcher<CommandSourceStack> commandDispatcher) {
        ...
        final LiteralArgumentBuilder<CommandSourceStack> litTargets = Commands.literal("lit")
                .then(Commands.argument("targets", EntityArgument.entities()).executes(
                        context -> litTargets(context.getSource(), EntityArgument.getEntities(context, "targets"))
                )).requires(commandSourceStack -> requiredLevel(commandSourceStack, 40));
        ...
        final LiteralArgumentBuilder<CommandSourceStack> transferHumanUnitDurability =
                ...
                )).requires(commandSourceStack -> requiredLevel(commandSourceStack, 120));
